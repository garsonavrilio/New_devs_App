...
export const RevenueSummary: React.FC<RevenueSummaryProps> = ({ propertyId = 'prop-001', debugTenant, showRaw }) => {
    ...
    // total_revenue arrives as a pre-rounded decimal string (e.g. "4975.50").
    // parseFloat is safe here — it is used only for locale display formatting,
    // not for any arithmetic calculation.
